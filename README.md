...
требуется при создании экземпляра класса ArtifactSet и используется при сериализации

# TODO
- в связи с изменениями в 6.0 провести ревизию баффов следующих персонажей: Байжу, Коллеи, Инеффа, Нахида, Нилу, Сетос
- настроить баффы за полный набор следующих артефактов: FlowerOfParadiseLost, NightOfTheSkysUnveiling, SilkenMoonsSerenade
